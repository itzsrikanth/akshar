# ನಾಟ್ಯಕಲಾ ದುರಂಧರ ಮಹಮ್ಮದ್ ಪೀರ್

> Editorial draft — not served to production apps. No CC license is asserted for this draft.

Editorial YAML under the same Git-only edition exception as Grade 4. Edition licensing remains unverified; excluded from production API and the repository's CC BY grant.
