...
Editorial YAML for Grade 4 Chapter 5 under the same Git-only edition exception. Temporarily colocated under the Grade 3 book until Grade 4 book identity is verified; excluded from production API.
