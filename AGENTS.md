...
The maintainer explicitly authorized committing the existing Grade 4 Chapters 1–2 YAML despite the unresolved edition-rights and renderer concerns, provided production apps remain unaffected. This is a narrow Git-storage exception, not evidence of a CC license or authorization to release these chapters through the app. Their `meta.license` truthfully records `Unverified; source PDF states NOT TO BE REPUBLISHED; no CC license asserted`. Do not copy this exception to other content automatically.
